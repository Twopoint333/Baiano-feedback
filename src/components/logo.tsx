    ...
    <div className={cn("inline-flex items-center gap-3", className)}>
      ...
      >
        ...
        <path
          ...
          fill="#FFFFFF"
        />
        <rect x="22" y="42" width="36" height="8" rx="4" fill="#000000" />
        <rect x="22" y="34" width="36" height="8" rx="4" fill="#000000" />
        <path
          d="M22 24C22 27.3137 24.6863 30 28 30H52C55.3137 30 58 27.3137 58 24V22H22V24Z"
          fill="#FFFFFF"
        />
        <circle cx="30" cy="26" r="2" fill="hsl(var(--primary))" />
        <circle cx="40" cy="23" r="2" fill="hsl(var(--primary))" />
        <circle cx="50" cy="26" r="2" fill="hsl(var(--primary))" />
      </svg>
